...
public:
  TestSuite() : sample_map_ptr(new lanelet::LaneletMap())
  {
    ...
    avyana_auto_mapping_msgs::msg::MapPrimitive map_primitive;
    avyana_auto_mapping_msgs::msg::HDMapSegment map_segment1;
    avyana_auto_mapping_msgs::msg::HDMapSegment map_segment2;
  ...
  avyana_auto_planning_msgs::msg::HDMapRoute sample_route1;  // valid route
  avyana_auto_planning_msgs::msg::HDMapRoute sample_route2;  // invalid route
...
{
  avyana_auto_mapping_msgs::msg::HDMapBin bin_msg;

  const auto route_ptr1 =
    std::make_shared<avyana_auto_planning_msgs::msg::HDMapRoute>(sample_route1);
  const auto route_ptr2 =
    std::make_shared<avyana_auto_planning_msgs::msg::HDMapRoute>(sample_route2);
