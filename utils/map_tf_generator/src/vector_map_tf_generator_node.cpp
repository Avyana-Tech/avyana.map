...
public:
  ...
  : Node("vector_map_tf_generator", options)
  {
    ...
    sub_ = create_subscription<avyana_map_messages::msg::HDMapBin>(
...
private:
  ...
  rclcpp::Subscription<avyana_map_messages::msg::HDMapBin>::SharedPtr sub_;

  std::shared_ptr<tf2_ros::StaticTransformBroadcaster> static_broadcaster_;
  std::shared_ptr<lanelet::LaneletMap> lanelet_map_ptr_;

  void onVectorMap(const avyana_map_messages::msg::HDMapBin::ConstSharedPtr msg)
  {
