...
using AvyanaTrafficLightConstPtr = std::shared_ptr<const lanelet::avyana::AvyanaTrafficLight>;
using DetectionAreaConstPtr = std::shared_ptr<const lanelet::avyana::DetectionArea>;
using NoStoppingAreaConstPtr = std::shared_ptr<const lanelet::avyana::NoStoppingArea>;
}  // namespace lanelet
